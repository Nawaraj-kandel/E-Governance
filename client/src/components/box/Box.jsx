...
const Box = ({icon, name, link}) => {
  ...
  return (
    <div className="w-60 h-24 border-2 cursor-pointer border-gray-300 rounded-lg shadow-md flex justify-around items-center transition duration-300 transform hover:scale-105 hover:shadow-lg">
