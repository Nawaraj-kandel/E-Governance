...
const ContactUs = () => {
    return (
        <div className='bg-green-200 min-h-screen flex justify-center items-center'>
            <div className='p-8 bg-white rounded-lg shadow-lg md:w-96 w-full'>
                ...
                <form>
                    ...
                    <div className='mb-4'>
                        ...
                        <input className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' id='location' type='text' placeholder='Enter your location' />
                    </div>
                    <div className='mb-4'>
