  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center h-screen bg-green-200">
      <div className="md:w-1/2 flex flex-col items-center justify-center px-4">
        ...
        <p className='font-bold mb-4 md:mb-8'>For getting access</p>
        
        {/* Use Link component instead of button */}
        <Link to="/userRegister" className='bg-green-600 hover:bg-green-700 text-white h-10 w-24 flex items-center justify-center rounded-md'>
          Sign up
        </Link>
      </div>
