...
//   return (
//     <div className=" h-20 bg-green-600 flex justify-between items-center px-6 mt-0">
//       <div>
...
//                     to={items.href}
//                     key={items.href}
//                     className="cursor-pointer hover:text-blue-400  bg-green-600   text-white"
//                   >
//                     {items.name}
//                   </Link>
//                 ))}
...
//               <ul className="w-24 h-20 border-2 flex flex-col border-none text-white bg-green-600 mt-4">
//                 {login.map((items) => (
//                   <Link
//                     to={items.href}
//                     key={items.href}
...
//   return (
//     <div className="bg-green-600 flex justify-between items-center px-6 mt-0">
...
//               <ul className="w-20 h-16 border-2 flex flex-col border-none mt-4">
//                 {register.map((items) => (
//                   <Link to={items.href} key={items.href} className="cursor-pointer hover:text-blue-400 bg-green-600 text-white">
//                     {items.name}
//                   </Link>
//                 ))}
//               </ul>
